...
export function WhatsAppButton() {
  const phoneNumber = '5511910074444';
  ...
  return (
    ...
    >
      <div className="relative">
        {/* Botão Principal com ícone oficial do WhatsApp */}
        <div className="w-14 h-14 bg-[#25D366] hover:bg-[#20BA5A] rounded-full flex items-center justify-center shadow-lg hover:shadow-xl transition-all duration-300 group-hover:scale-110 relative overflow-hidden">
        ...
        {/* Efeito de Pulso */}
        <div className="absolute inset-0 bg-[#25D366] rounded-full animate-ping opacity-20 group-hover:opacity-30"></div>
