...
export const metadata = {
  title: 'Automação da Força de Vendas (SFA) | OLV Internacional + TOTVS',
  description:
    'SFA integrado ao CRM e ERP TOTVS para vendas externas de alta performance. Consultoria estratégica OLV.',
};

const cases = getCasesByProduto('SFA');

export default function SFAPage() {
  const solucao = getSolucaoBySlug('sfa');
  ...
  return (
    <>
      ...
      <IntroducaoInstitucionalOLV
        nomeSolucao="TOTVS SFA"
        aplicacaoEspecifica="automação de vendas externas, gestão de força de vendas, pedidos mobile e roteirização integrada ao CRM e ERP"
      />
      ...
      {/* EXEMPLOS DE APLICAÇÃO - 1 CASO REAL */}
          ...
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-neutral-600">
                Como empresas aceleram vendas externas com TOTVS SFA
              </p>
            </div>
            ...
            {cases.map((caso, index) => (
              <div key={index} className="mb-12">
                <ExemploDeAplicacao
                  setor={caso.setor}
                  tipoEmpresa="Empresas com equipes de vendas externas"
                  desafioComum="Pedidos lentos, informações desatualizadas em campo, dificuldade de rastrear produtividade da força de vendas"
                  ...
                  comoPodemos={[
                    {
                      etapa: 'Diagnóstico de Operação de Campo (OLV)',
                      descricao:
                        'Mapeamos rotina de vendedores, tempo de processamento de pedidos, acesso a informações (estoque, preços, histórico) e gargalos operacionais.',
                    },
                    {
                      etapa: 'Desenho de Processo Mobile (OLV)',
                      descricao:
                        'Desenhamos fluxo ideal: consulta de clientes, verificação de estoque em tempo real, emissão de pedidos offline, roteirização otimizada.',
                    },
                    {
                      etapa: 'Integração com CRM e ERP (OLV + TOTVS)',
                      descricao:
                        'Facilitamos integração com TOTVS CRM (histórico de interações) e ERP (estoque, preços, crédito) para vendedor ter visão completa em campo.',
                    },
                    {
                      etapa: 'Implementação de SFA (TOTVS)',
                      descricao:
                        'TOTVS implementa app mobile: catálogo de produtos, pedidos com validação de regras, sincronização offline, roteirização, dashboards de performance.',
                    },
                    {
                      etapa: 'Otimização de Produtividade (OLV)',
                      descricao:
                        'Analisamos métricas (tempo de pedido, ticket médio, produtividade por vendedor), sugerimos melhorias (gamificação, novos recursos).',
                    },
                  ]}
                />
              </div>
      ...
      <section className="section bg-white">
        <div className="container-custom">
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p className="text-lg text-neutral-600">
              Tudo que sua força de vendas precisa no bolso
            </p>
          </div>
      ...
      <section className="section bg-neutral-50">
        <div className="container-custom">
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p className="text-lg text-neutral-600">
              Resultados tangíveis em produtividade e qualidade de pedidos
            </p>
          </div>
        ...
        <div className="container-custom relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-h2 font-bold mb-4">
              Acelere Suas Vendas Externas com SFA
            </h2>
            <p className="text-xl mb-8 text-white/90">
              Faça um diagnóstico gratuito e descubra como otimizar sua força de vendas
            </p>
