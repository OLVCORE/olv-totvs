...
export const metadata = {
  title: 'Soluções de Pagamentos TOTVS | OLV Internacional',
  description:
    'Pagamentos instantâneos, checkout moderno e frente de caixa integrada. Consultoria OLV + tecnologia TOTVS Techfin.',
};

const cases = getCasesByProduto('Pagamentos (Techfin)');

export default function PagamentosPage() {
  const solucao = getSolucaoBySlug('pagamentos');
  ...
  return (
    <>
      ...
      <IntroducaoInstitucionalOLV
        nomeSolucao="TOTVS Pagamentos"
        aplicacaoEspecifica="pagamentos instantâneos, checkout digital, frente de caixa e meios de pagamento integrados"
      />
        ...
        <div className="container-custom">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-h2 font-bold text-neutral-900 mb-6">
              O que são Soluções de Pagamentos TOTVS?
            </h2>
            <p className="text-lg text-neutral-700 leading-relaxed">
              Ecossistema completo de pagamentos integrado ao seu ERP: Pix, cartões, boletos,
              QR Code, checkout digital e frente de caixa. Reduz atritos, acelera conciliação
              e melhora experiência do cliente, com rastreabilidade total e integrações nativas
              com TOTVS Techfin.
            </p>
          </div>
        </div>
          ...
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-neutral-600">
                Como empresas aceleram pagamentos e melhoram experiência com soluções TOTVS
              </p>
            </div>
            ...
            {cases.map((caso, index) => (
              <div key={index} className="mb-12">
                <ExemploDeAplicacao
                  ...
                  comoPodemos={[
                    {
                      etapa: 'Diagnóstico de Fluxo de Pagamentos (OLV)',
                      descricao:
                        'Mapeamos todos os meios de pagamento, prazos de repasse, custos de conciliação e pontos de atrito no checkout ou PDV.',
                    },
                    {
                      etapa: 'Desenho de Solução Integrada (OLV)',
                      descricao:
                        'Mostramos como pagamentos instantâneos, checkout moderno ou totem podem melhorar velocidade, experiência e custo total no seu contexto.',
                    },
                    {
                      etapa: 'Facilitação Técnica (OLV + TOTVS)',
                      descricao:
                        'Conectamos com time TOTVS Techfin para definir integrações com ERP, meios de pagamento, conciliação automática e governança financeira.',
                    },
                    {
                      etapa: 'Implementação de Pagamentos (TOTVS)',
                      descricao:
                        'TOTVS implementa solução completa: Pix, cartões, QR Code, checkout ou totem, integração com backoffice, dashboards de conciliação.',
                    },
                    {
                      etapa: 'Evolução e Expansão (OLV)',
                      descricao:
                        'Acompanhamos métricas (tempo de repasse, custo de transação), sugerimos expansões (novos canais, antecipação de recebíveis).',
                    },
                  ]}
                />
              </div>
      ...
      <section className="section bg-white">
        <div className="container-custom">
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p className="text-lg text-neutral-600">
              Meios de pagamento integrados ao seu sistema de gestão
            </p>
          </div>
      ...
      <section className="section bg-neutral-50">
        <div className="container-custom">
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p className="text-lg text-neutral-600">
              Resultados tangíveis em velocidade, custo e experiência
            </p>
          </div>
        ...
        <div className="container-custom relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-h2 font-bold mb-4">
              Acelere Pagamentos e Melhore Experiência
            </h2>
            <p className="text-xl mb-8 text-white/90">
              Faça um diagnóstico gratuito e descubra como modernizar seus pagamentos
            </p>
